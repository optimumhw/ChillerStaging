...
public class PopupMenuForChillerStagingTable extends JPopupMenu {

    public PopupMenuForChillerStagingTable(java.awt.event.MouseEvent evt, final JTable table) {
